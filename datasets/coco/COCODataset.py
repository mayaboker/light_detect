...
class COCODataset(Dataset):
    def __init__(self, data_path, mode='train', augment=None, strides=(4,)):
        file_data = os.path.join(data_path, 'instances_'+mode+'2017.json')
        self.labels = []
        self.strides = strides
        self.f_imgs = glob.glob(data_path + '/coco_person/' + '*.jpg')
        self.min_box = 8
...
if __name__ == '__main__':
    ...
    annotations_file = r'/home/core4/data/coco'
    coco = COCODataset(annotations_file, mode='train', augment=get_train_transforms(cfg['train']['transforms']), strides=(4, 8))
